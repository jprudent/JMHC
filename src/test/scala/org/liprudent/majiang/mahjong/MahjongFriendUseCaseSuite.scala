 ...
 * {{{
    ...
    """use case :
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List())
...
class MahjongFriendUseCaseSuite extends FunSuite {
  ...
  test(
    ...
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b3, b3))
  ...
  test("case Mixed Triple Chows - All Chows") {
    val givenClosed = TocTileSet(List(s2, s3, s4, s6, s7, s8, s9, s9))
  ...
  test("case Upper Four - Flowers - Double Chow - Closed Wait") {
    ...
    val givenClosed = TocTileSet(List(s6, s6, s6, s7, s8, s9, c6, c6))
  ...
  test("case All Types - SeatWind - Flower - Single Wait") {
    ...
    val givenClosed = TocTileSet(List(b2, b2, b2, c1, c2, c3, dg, dg))
  ...
  test("case Knitted Straight - Fully Concealed Hand") {
    val givenClosed = TocTileSet(List(b1, b4, b7, c2, c5, c8, s3, s6, s9, c8, c8, c8, dr, dr))
    val givenMelded = Nil
  ...
  test("case Knitted Straight - All Types") {
    ...
    val givenClosed = TocTileSet(List(b1, b4, b7, c2, c5, c8, s3, s6, s9, dr, dr))
  ...
  test(
    ...
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b1, b2, b3, b7, b8, b9, c7, c8, c9, s7, s8, s9, dr, dr))
    val givenMelded = Nil
    val givenContextualTile: ContextualTile = ContextualTile(b1, SelfDrawn, NotLastTile)
    val givenBonus: Bonus = Bonus(Nil)
    val givenContext = PlayerContext(WestWind, EastWind)
  ...
  test(
    """case Half Flush - Pung of terminals or honor - Self Drawn - Flowers
      ...
      |verif : mahjong friends
    """.stripMargin) {
    val givenClosed = TocTileSet(List(s2, s2, s2, s5, s6, s4, we, we))
  ...
  test(
    ...
    """.stripMargin) {
    val givenClosed = TocTileSet(List(we, we, dr, dr, dg, dg, b1, b1, b9, b9, c1, c1, s9, s9))
    val givenMelded: List[Figure] = List()
  ...
  test(
    ...
    """.stripMargin) {
    val givenClosed = TocTileSet(List(s3, s4, s5, b1, b2, b3, b4, b5, b6, b2, b2))
  ...
  test(
    ...
    """.stripMargin) {
    val givenClosed = TocTileSet(List(s4, s5, s6, b1, b2, b3, b6, b7, b8, b3, b3))
    val givenMelded: List[Figure] = List(Chow(c5, c6, c7))
  ...
  test(
    ...
    """.stripMargin) {
    val givenClosed = TocTileSet(List(c1, c2, c3, ww, ww, ws, ws, ww))
  ...
  test(
    ...
    """.stripMargin) {
    val givenClosed = TocTileSet(List(c9, c9, c9, ww, ww, ww, b2, b2))
  ...
  test(
    ...
    """.stripMargin) {
    val givenClosed = TocTileSet(List(s6, s7, s8, c3, c4, c5, c2, c2))
  ...
  test(
    """No Honors
      |verif : Mahjong Friends
    """.stripMargin) {
    val givenClosed = TocTileSet(List(s9, s9))
  ...
  test(
    """use case :
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(s3, s4, s5, s3, s3))
  ...
  test(
    """use case : Mixed Shifted Pungs - All Pungs - Prevalent Wind
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(s1, s1, s1, s2, s2))
  ...
  test(
    """use case : Two Terminal Chows
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(s4, s4))
  ...
  test(
    """use case : Concealed Kong - Double Pung
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b6, b6, c8, c8, c8))
  ...
  test(
    """use case : Two concealed pungs
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b1, b1, b1, b4, b4, b4, b7, b7, b7, dw, dw))
  ...
  test(
    ...
    """.stripMargin) {
    val givenClosed = TocTileSet(List(c8, c8))
  ...
  test(
    """use case : Last Tile
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(c1, c1, c1, s4, s5, s2, s2, s3))
  ...
  test(
    """use case : Two Dragons Pungs
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(s1, s1))
  ...
  test(
    ...
    """.stripMargin) {
    val givenClosed = TocTileSet(List(s7, s7, s7, c1, c1, c1, dr, dr, dr, ws, ws))
  ...
  test(
    ...
    """.stripMargin) {
    val givenClosed = TocTileSet(List(s4, s4, s4, c2, c3, c4, s2, s2))
  ...
  test(
    """use case : Concealed Hand - Last Tile
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(s7, s9, b3, b4, b5, b6, b7, b8, c6, c7, c8, c5, c5, s8))
    val givenMelded: List[Figure] = List()
  ...
  test(
    """use case : Two concealed kongs
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(c1, c1))
  ...
  test(
    """use case : Robbing the kong
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b3, b4, c2, c3, c4, c6, c6, b5))
  ...
  test(
    """use case : Out with replacement tile
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(c1, c2, c3, c4, c4))
  ...
  test(
    """use case : Three Concealed Pungs
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(c1, c1, c1, dr, dr))
  ...
  test(
    ...
    """.stripMargin) {
    val givenClosed = TocTileSet(List(s4, s5, s6, c1, c2, c3, b7, b7))
  ...
  test(
    """use case : Last Tile Draw
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(ws, ws))
  ...
  test(
    """use case : Chicken Hand
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(s4, s5, s7, s7, s7, b1, b2, b3, we, we, s3))
  ...
  test(
    """use case : Chicken Hand with flower
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b6, b7, c4, c5, c6, ww, ww, b5))
  ...
  test(
    """use case : Big Three Winds
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b5, b5, b5, c9, c9))
  ...
  test(
    """use case : Big Three Winds - Pung of Terminal
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b5, b5, c9, c9, c9))
    val givenMelded: List[Figure] = List(Pung(wn), Pung(ww), Pung(ws))
    val givenContextualTile: ContextualTile = ContextualTile(b5, Discarded, NotLastTile)
    val givenConcealedKongs = List()
    val givenBonus: Bonus = Bonus(Nil)
  ...
  test(
    """use case : Triple Pung
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b2, b3, b4, b4, b4))
  ...
  test(
    """use case : All Five
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(s5, s5, c4, c5, c6))
  ...
  test(
    """use case : Three suited terminal chows
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(s5, s5))
  ...
  test(
    """use case : 2 x TileHog
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b2, b2))
  ...
  test(
    """use case : Pure Straight
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b1, b2, b3, b6, b7, b8, b8, b8))
  ...
  test(
    """use case : Pure Triple Chow - Upper Tiles
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(c9, c9))
  ...
  test(
    """use case : Four concealed pungs - All Even Pungs
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b2, b2, b2, b4, b4, b4, c6, c6, c6, s8, s8, s8, b6, b6))
    val givenMelded: List[Figure] = List()
  ...
  test(
    """use case : Pure Shifted Pungs - Middle Tiles
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(c5, c5))
  ...
  test(
    """use case : Four Shifted Chows by 1
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(dr, dr))
  ...
  test(
    """use case : Four pure shifted pungs
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b1, b1))
  ...
  test(
    """use case : Pure Terminal Chows
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b1, b2, b3, b5, b5))
  ...
  test(
    """use case: Little three dragons
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(dr, dr, c4, c5, c6))
  ...
  test(
    """use case : Little four winds
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(we, we, c1, c1, c1))
    val givenMelded: List[Figure] = List(Pung(wn), Pung(ww), Pung(ws))
    val givenContextualTile: ContextualTile = ContextualTile(c1, Discarded, NotLastTile)
    val givenConcealedKongs = List()
    val givenBonus: Bonus = Bonus(Nil)
  ...
  test(
    """use case : Seven shifted pairs
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b2, b2, b3, b3, b4, b4, b5, b5, b6, b6, b7, b7, b8, b8))
    val givenMelded: List[Figure] = List()
    val givenContextualTile: ContextualTile = ContextualTile(b2, Discarded, NotLastTile)
    val givenConcealedKongs = List()
    val givenBonus: Bonus = Bonus(Nil)
  ...
  test(
    """use case : All Green
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b6, b6, b8, b8, b8))
  ...
  test(
    """use case : Nine Gates
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(b5, b6, b7, b8, b8))
  ...
  test(
    """use case : Big Four Winds
      ...
      |tricky part:
    """.stripMargin) {
    val givenClosed = TocTileSet(List(we, we, we, wn, wn, wn, ww, ww, ww, ws, ws, ws, dr, dr))
    val givenMelded: List[Figure] = List()
    val givenContextualTile: ContextualTile = ContextualTile(dr, Discarded, NotLastTile)
    val givenConcealedKongs = List()
    val givenBonus: Bonus = Bonus(Nil)
    ...
    val thenCombinations: List[(List[Figure], Combination)] =
      List(
        (List(Pung(we), Pung(wn), Pung(ww), Pung(ws)), BigFourWinds),
        (allFigures, AllHonors),
        (List(Pung(we), Pung(wn), Pung(ww), Pung(ws)), FourConcealedPungs),
        (allFigures, ConcealedHand),
        (List(Dui(dr)), SingleWait)
      )
